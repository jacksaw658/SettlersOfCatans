...
import guiClasses.boardGUI.CatanWindow;
...
public class PlayGame {
	...
	public void Play() {
		...
		setPlayers();
		CatanWindow gameWindow = new CatanWindow(board,numPlayers,playerList);
		gameWindow.addPlayerFrames(numPlayers, playerList);
	...
	private void setPlayers() {
		...
		playerList = setup.initiateGame();
		numPlayers = setup.getNumPlayers();
